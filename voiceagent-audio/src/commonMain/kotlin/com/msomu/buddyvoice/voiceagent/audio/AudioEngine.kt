 ...
 *
 * Platform availability: Android (Phase 1), iOS (Phase 2), Desktop/JVM (Phase 4).
 * The Web actual arrives in a later phase and currently throws [UnsupportedOperationException].
 *
